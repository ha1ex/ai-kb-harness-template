...
<!-- ЗАМЕНИТЕ: одно-два предложения о цели проекта.
Пример: «Этот репозиторий — knowledge base продуктового решения X.
Цель — собрать и систематизировать evidence для переработки фичи Y.» -->

TODO: опишите цель проекта.

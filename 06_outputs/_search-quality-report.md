...
| # | ID | Provider | Category | Title | Heading |
| - | - | - | - | - | - |
| 1 | `A-065` | cybos-cases | Engineering productivity | Parallel-agent dev workflow — 4–6 subsystem agents in worktr | Parallel-agent dev workflow — 4–6 subsys |
| 2 | `C-085` | cybos-cases | Engineering productivity | Global port-registry CLI for parallel agents on the same mac | Global port-registry CLI for parallel ag |
| 3 | `A-089` | cybos-cases | Engineering productivity | Six-pattern delegation framework with a two-tier light/full  | Why it matters |
| 4 | `B-042` | cybos-cases | Engineering productivity | Multi-Agent Dev Pipeline (4 agents) | Multi-Agent Dev Pipeline (4 agents) |
| 5 | `A-067` | cybos-cases | Engineering productivity | Subsystem-specialized agent teams — orchestrator + 4-12 para | What |
...
| # | ID | Provider | Category | Title | Heading |
| - | - | - | - | - | - |
| 1 | `B-166` | cybos-cases | Marketing & content | Landing-page copy generator — 7-block structure + 5-objectio | Landing-page copy generator — 7-block st |
| 2 | `B-177` | cybos-cases | Marketing & content | Page-type mismatch diagnosis via reverse-engineered SERPs | End-to-end |
| 3 | `A-055` | cybos-cases | Marketing & content | Google Ads bulk campaign launcher — competitor keywords → la | End-to-end |
| 4 | `A-078` | cybos-cases | Marketing & content | Landing-page audit for paid ads — 5-dimension weighted healt | Landing-page audit for paid ads — 5-dime |
...
| # | ID | Provider | Category | Title | Heading |
| - | - | - | - | - | - |
| 1 | `B-104` | cybos-cases | Marketing & content | Competitive-landing-analysis skill — 100 competitors → hypot | Why it matters |
| 2 | `A-035` | cybos-cases | Strategy & leadership | Positioning-statement plugin | End-to-end |
| 3 | `B-174` | cybos-cases | Marketing & content | Competitor profiling with Firecrawl + DataForSEO | Competitor profiling with Firecrawl + Da |
...
| 2 | `C-036` | cybos-cases | Strategy & leadership | Leadership-communication reference frameworks | Leadership-communication reference frame |
| 3 | `A-036` | cybos-cases | Strategy & leadership | Diagnostic-to-Dashboard methodology | End-to-end |
| 4 | `A-084` | cybos-cases | Marketing & content | Full GTM launch playbook — motion by ACV, ORB channels, mult | Prompts |
...
| 3 | `B-062` | cybos-cases | Founder productivity | Sales pipeline data extraction — durable entities | Why it matters |
...
| 5 | `FAB-006` | fabric | Engineering productivity | Create Design Document | End-to-end |
...
| 4 | `B-154` | cybos-cases | Infrastructure | Vercel + Neon Postgres + GitHub as the DevOps-free serverles | What |
...
| # | ID | Provider | Category | Title | Heading |
| - | - | - | - | - | - |
| 1 | `B-067` | cybos-cases | Infrastructure | Self-installable Claude Code skill via HTTP | Self-installable Claude Code skill via H |
| 2 | `A-030` | cybos-cases | Knowledge management | Skills knowledge-graph visualization | Tools |
| 3 | `B-182` | cybos-cases | Marketing & content | Programmatic SEO page factory with thin-content guardrails | Tools |
| 4 | `A-077` | cybos-cases | Sales & outbound | Anonymous-visitor → outbound pipeline with suppression, revi | Tools |
...
| # | ID | Provider | Category | Title | Heading |
| - | - | - | - | - | - |
| 1 | `A-007` | cybos-cases | Sales & outbound | Hook-driven cold outreach as a managed program | Tools |
| 2 | `A-076` | cybos-cases | Sales & outbound | Recursive 10-expert-panel cold-email optimizer | Recursive 10-expert-panel cold-email opt |
| 3 | `A-077` | cybos-cases | Sales & outbound | Anonymous-visitor → outbound pipeline with suppression, revi | Tools |
...
| 3 | `A-092` | cybos-cases | Strategy & leadership | Founder Chief of Staff orchestrator across 10 C-suite role a | End-to-end |
| 4 | `B-033` | cybos-cases | Operations | Meeting transcription + follow-up auto-tasks | Meeting transcription + follow-up auto-t |
| 5 | `FAB-100` | fabric | Operations | Summarize Meeting | Summarize Meeting |
...
| 4 | `C-143` | cybos-cases | Founder productivity | Phased conversational audit of a long-running context corpus | What |
| 5 | `COB-036` | anthropic-cookbooks | Engineering productivity | Metaprompt | @title Metaprompt Text |
...
| 2 | `B-163` | cybos-cases | Sales & outbound | Behavior-first B2B buyer persona + champion-risk + multi-thr | Behavior-first B2B buyer persona + champ |
...
| # | ID | Provider | Category | Title | Heading |
| - | - | - | - | - | - |
| 1 | `A-019` | cybos-cases | Operations | Daily Focus skill — intentional manual morning ritual | Daily Focus skill — intentional manual m |
| 2 | `B-106` | cybos-cases | Marketing & content | Solo-founder marketing stack on autopilot — Claude Code + MC | Solo-founder marketing stack on autopilo |
| 3 | `A-043` | cybos-cases | Founder productivity | Founder personal dashboard — custom HTML, MCP-fed, with char | What |
| 4 | `B-017` | cybos-cases | HR & hiring | 1:1 & review prep skill | Why it matters |
| 5 | `A-040` | cybos-cases | Strategy & leadership | Four-week three-stream launch plan (People / Pilots / Educat | Tools |
...
| 4 | `A-006` | cybos-cases | Sales & outbound | Call scoring (sales + QA): same engine, two consumers | Prompts |
...
| # | ID | Provider | Category | Title | Heading |
| - | - | - | - | - | - |
| 1 | `B-186` | cybos-cases | Customer success | SaaS churn-prevention system — cancel flow + dunning + save- | SaaS churn-prevention system — cancel fl |
| 2 | `B-091` | cybos-cases | HR & hiring | Franchise / team onboarding skill (first-day Claude Code ski | Gotchas |
| 3 | `B-052` | cybos-cases | Data & BI | Churn prediction — start rule-based, mature into ML | What |
| 4 | `A-008` | cybos-cases | Sales & outbound | Risk-of-churn case worker embedded in the CRM | Prompts |
| 5 | `B-187` | cybos-cases | Customer success | Mobile-app onboarding optimization — activation event + perm | Mobile-app onboarding optimization — act |
...
| # | ID | Provider | Category | Title | Heading |
| - | - | - | - | - | - |
| 1 | `B-051` | cybos-cases | Data & BI | Natural-language analytics over your warehouse | Natural-language analytics over your war |
| 2 | `A-029` | cybos-cases | Data & BI | One-prompt BI agent that builds a dashboard from a sentence | What |
| 3 | `A-032` | cybos-cases | Knowledge management | Token metabolism — knowledge graph as company memory | Tools |
| 4 | `A-037` | cybos-cases | Strategy & leadership | Eliminate-role unlock chain — the prerequisite map for repla | End-to-end |
| 5 | `B-093` | cybos-cases | Data & BI | AI-built financial dashboards over CRM + ERP + bank APIs | Gotchas |
...
| 4 | `A-037` | cybos-cases | Strategy & leadership | Eliminate-role unlock chain — the prerequisite map for repla | End-to-end |
| 5 | `B-094` | cybos-cases | Marketing & content | Brand-style ingestion into Claude Design (2-month maturation | Tools |
...
| # | ID | Provider | Category | Title | Heading |
| - | - | - | - | - | - |
| 1 | `B-110` | cybos-cases | Operations | Install Anthropic's pdf / xlsx / pptx skills to ship client- | End-to-end |
...
| 4 | `C-076` | cybos-cases | Marketing & content | Claude-in-PowerPoint to reformat rough decks against a corpo | Claude-in-PowerPoint to reformat rough d |
...
| 2 | `COB-054` | anthropic-cookbooks | Engineering productivity | Introduction to Claude Skills | Create an Excel budget spreadsheet |
